...
In the non-stationary model, the variance of the model, $\sigma^2(\mathbf{x})$ varies with $\mathbf{x}$. If this variance is constant, $\sigma^2$, then the model is stationary.
