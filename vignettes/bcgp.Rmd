...
# predY <- data.frame(x = nsc$xTest, y = nsc$yTest)
# predG <- data.frame(x = nsc$xTest, y = nsc$yGTest)
# predL <- data.frame(x = nsc$xTest, y = nsc$yLTest)
# predV <- data.frame(x = nsc$xTest, y = nsc$parameters$VTest)
dataY <- data.frame(x = nsc@training$x, y = nsc@training$y)
predY <- data.frame(x = nsc@test$x, y = nsc@test$y)
predG <- data.frame(x = nsc@test$x, y = nsc@test$yG)
predL <- data.frame(x = nsc@test$x, y = nsc@test$yL)
predV <- data.frame(x = nsc@test$x, y = nsc@parameters$VTest)
...
# predY <- data.frame(x = snc$xTest, y = snc$yTest)
dataY <- data.frame(x = snc@training$x, y = snc@training$y)
predY <- data.frame(x = snc@test$x, y = snc@test$y)
